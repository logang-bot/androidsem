...
public class displayDeleteUser extends AppCompatActivity {

    private displayDeleteUser root = this;
    private Button confirmButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_delete_user);
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder1.setMessage("¿ESTAS SEGURO/A QUE DESEAS ELIMINAR TU CUENTA?");
